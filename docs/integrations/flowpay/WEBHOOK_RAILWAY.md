...
Authorization: your_webhook_secret_XXXXX  # Seu WOOVI_WEBHOOK_SECRET
...
3. Woovi envia webhook para Railway
   URL: https://flowpay-production-10d8.up.railway.app/api/webhook
   Authorization: your_webhook_secret_XXXXX
   ↓
...
3. **WOOVI_WEBHOOK_SECRET configurado no Railway**
   ...
   - Deve conter: `WOOVI_WEBHOOK_SECRET=your_webhook_secret_XXXXX`
...
WOOVI_WEBHOOK_SECRET=your_webhook_secret_XXXXX
...
4. Authorization: `your_webhook_secret_XXXXX`
