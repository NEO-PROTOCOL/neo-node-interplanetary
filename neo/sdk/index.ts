...
export type { NeoSkill, NeoSkillsIndex } from '../registry/index'
export type { NeoIdentity } from '../identity/mio-system'
export type { NeoIdentityRole } from '../identity/registry'

// Re-export classes
export { NeoSkillsRegistry, createNeoSkillsRegistry } from '../registry/index'
export { 
  MioIdentityManager, 
  createMioIdentityManager,
  isValidMioId,
  generateMioId 
} from '../identity/mio-system'
 ...
 */
export function createNeoClient(options?: {
  ipfsEndpoint?: string
  privateKey?: string
}) {
  return {
    ...
    identity: options?.privateKey 
      ? createMioIdentityManager(options.privateKey)
      : null,
 ...
 */
export function isNeoSkill(obj: any): obj is import('../registry/index').NeoSkill {
  return (
    typeof obj === 'object' &&
 ...
 */
export function isNeoIdentity(obj: any): obj is import('../identity/mio-system').NeoIdentity {
  return (
    typeof obj === 'object' &&
    typeof obj.id === 'string' &&
